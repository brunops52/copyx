      ...
      <div className="w-full h-full min-h-screen border-x-1 border-neutral-700 text-white font-bold relative">
        ...
        >
          <h2 className="text-xl flex items-center">
            {user.first_name} {user.last_name} <AiFillLock className="ml-2" />
          </h2>
              ...
              <div className="flex items-center justify-between px-5">
                ...
                {isFollowing ? (
                  ...
                  <>
                    <button
                      onClick={handleFollowSubmit}
                      className="bg-white py-2 px-7 rounded-full text-black border-2 border-neutral-700 cursor-pointer hover:bg-neutral-200"
                    >
                      Seguir
                    </button>
                  </>
